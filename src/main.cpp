...
const int ACCEL_STEPS = 70;  // Changed from 70 to 140 (maintains same acceleration ratio)
const int DECEL_STEPS = 30;   // Changed from 30 to 60 (maintains same deceleration ratio)
